...
class InjectScript extends ClientCommand {
    ...
    command(scriptUrl, id, callback) {
        ...
        const script = function (u, i) { return (function (d) { var e = d.createElement('script'); var m = d.getElementsByTagName('head')[0]; e.src = u; if (i) {
            e.id = i;
        } m.appendChild(e); return e; })(document); };
