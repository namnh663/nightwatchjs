...
class ApiLoader {
    ...
    addCommandDefinitionSync({ dirPath, isUserDefined = false, fileName, parent, namespace = [], abortOnFailure = false, isProtocolCommand = false, isElementCommand = false, elementCommandStrict = false, Loader = CommandLoader }) {
    ...
    async addCommandDefinitionAsync({ dirPath, isUserDefined = false, fileName, parent, namespace = [], abortOnFailure = false, isElementCommand = false, Loader = CommandLoader }) {
        const loader = new Loader(this.nightwatchInstance);
        loader.isUserDefined = isUserDefined;
        if (namespace && namespace.length) {
            loader.setNamespace(namespace);
    ...
    __loadCommandsSync({ parent = null, namespacesObj = null, ns = null, dirPath, originalSourcePath, abortOnFailure = false, isProtocolCommand = false, isElementCommand = false, isUserDefined = false, elementCommandStrict = false, Loader = CommandLoader, loadAction = this.addCommandDefinitionSync.bind(this) }) {
        if (namespacesObj) {
    ...
    __loadCommands({ parent = null, namespacesObj = null, ns = null, dirPath, abortOnFailure = false, isProtocolCommand = false, isElementCommand = false, isUserDefined = false, Loader = CommandLoader, loadAction = this.addCommandDefinitionAsync.bind(this) }) {
        if (namespacesObj) {
    ...
    __loadPluginTransforms(nextTransforms) {
        this.nightwatchInstance.transforms = this.nightwatchInstance.transforms.then(existingTransforms => this.__normalizeTransforms(nextTransforms).then(items => existingTransforms.concat(items)));
    }
}
