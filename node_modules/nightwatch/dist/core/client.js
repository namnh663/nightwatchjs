...
class NightwatchClient extends EventEmitter {
    ...
    setHttpOptions() {
        ...
        const { port, host, timeout_options = {}, ssl = false, keep_alive, proxy, default_path_prefix, username, access_key, internal_server_error_retry_interval } = this.settings.webdriver;
        if (port) {
