        ...
        return {
            ...
            session: {
                ...
                async setElementAttribute(webElement, attrName, value) {
                    ...
                    /* istanbul ignore next */ const fn = function (e, a, v) { try {
                        ...
                        return { error: err.message, message: err.name + ': ' + err.message };
                    } };
                ...
                async setGeolocation(coordinates) {
                    const cdpConnection = await cdp.getConnection(this.driver);
                    await cdpConnection.execute('Emulation.setGeolocationOverride', coordinates);
                    return {
                        value: null
                    };
                },
                ...
                async setDeviceMetrics(metrics) {
                    const cdpConnection = await cdp.getConnection(this.driver);
                    await cdpConnection.execute('Emulation.setDeviceMetricsOverride', metrics);
                    return {
                        value: null
                    };
                },
                ...
                async mockNetworkResponse(urlToIntercept, response) {
                    ...
                    await cdpConnection.execute('Network.setCacheDisabled', { cacheDisabled: true });
                    return {
                        value: null
                    };
                },
